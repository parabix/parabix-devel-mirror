...
class Compressor:
    ...
    def Compress(self, words):
        ...
        # TODO:
        # 1. encode a repeated sequence of same symbol,
        # (Ex: ===============) in a compact manner (similar to RLE)
        # 2. implement a word enlarging technique to compress already encoded sequence of symbols
        # 3. if a shorter symbol is occurring in part of a longer symbol, encode part of the longer symbol
