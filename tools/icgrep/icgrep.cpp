...
int main(int argc, char *argv[]) {
    ...
    if ((argv::OutputEncodingFlag == argv::OutputEncoding::UTF8) ||
        (argv::OutputEncodingFlag == argv::OutputEncoding::UTF16LE) ||
        (argv::OutputEncodingFlag == argv::OutputEncoding::UTF16BE)) grep->OutputEncodingOption(argv::OutputEncodingFlag);
    //keep output encoding same as input encoding if OutputEncodingFlag not set
        ...
        if (argv::InputEncodingFlag == argv::InputFileEncoding::InputFileEncoding::UTF16BE)
            grep->OutputEncodingOption(argv::OutputEncoding::OutputEncoding::UTF16BE);
        if (argv::InputEncodingFlag == argv::InputFileEncoding::InputFileEncoding::UTF16LE)
