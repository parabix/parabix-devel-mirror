...
void generateScanMatch(Module * m, IDISA::IDISA_Builder * iBuilder, int scanwordBitWidth, KernelBuilder * kBuilder, bool isNameExpression){
    ...
    kBuilder->extendKernelInternalStateType(S);
    kBuilder->extendKernelInternalStateType(T);
    kBuilder->extendKernelInternalStateType(S);
