...
public:
    ...
    void setInstanceParameters(std::vector<ParameterBinding> binding);
    ...
    llvm::Function * createInitMethod();
...
private:
    ...
    std::vector<ParameterBinding>           mInstanceParameters;
    unsigned                            mInstanceParametersOffset;
