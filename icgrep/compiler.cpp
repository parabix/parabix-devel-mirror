...
LLVM_Gen_RetVal compile(const Encoding encoding, const std::string input_string, const bool show_compile_time) {
    ...
    std::cerr << "Pablo CC AST:" << std::endl << StatementPrinter::Print_CC_PabloStmts(main.statements()) << std::endl;
    #endif
    ...
    std::cerr << "Final Pablo AST:" << StatementPrinter::Print_CC_PabloStmts(main.statements()) << ")" << std::endl;
    #endif

    PabloCompiler pablo_compiler(cc_compiler.getBasisBitVars(), encoding.getBits());
