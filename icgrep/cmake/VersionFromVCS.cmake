  ...
  if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.svn" OR EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../.svn" )
    ...
    if( Subversion_FOUND )
      ...
      if( Project_WC_REVISION )
        ...
        set(result "${result}_r${Project_WC_REVISION}")
      endif()
    endif()
  elseif( EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/.git )
    set(result "${result}git")
    # Try to get a ref-id
    if( EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/.git/svn OR EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/../.git/svn )
      ...
      if( git_executable )
        ...
        if( git_result EQUAL 0 )
          ...
          set(git_svn_rev "_svn_${git_svn_rev}")
        ...
        if( git_result EQUAL 0 AND NOT is_git_svn_rev_exact )
          ...
          set(result "${result}${git_svn_rev}_${git_ref_id}")
        else()
