...
UCD::codepoint_t Alphabet::toUnicode(const unsigned n) const {
...
unsigned Alphabet::fromUnicode(const UCD::codepoint_t codepoint) const {
...
template <class uint_t> UCD::codepoint_t ExtendedASCII<uint_t>::toUnicode(const unsigned n) const {
...
template <class uint_t> unsigned ExtendedASCII<uint_t>::fromUnicode(const UCD::codepoint_t codepoint) const {
