...
namespace UCD {
    ...
    namespace SCX_ns {
        enum value_t {
            Aghb, Arab, Armi, Armn, Avst, Bali, Bamu, Bass, Batk, Beng,
            Bopo, Brah, Brai, Bugi, Buhd, Cakm, Cans, Cari, Cham, Cher,
            Copt, Cprt, Cyrl, Deva, Dsrt, Dupl, Egyp, Elba, Ethi, Geor,
            Glag, Goth, Gran, Grek, Gujr, Guru, Hang, Hani, Hano, Hebr,
            Hira, Hmng, Hrkt, Ital, Java, Kali, Kana, Khar, Khmr, Khoj,
            Knda, Kthi, Lana, Laoo, Latn, Lepc, Limb, Lina, Linb, Lisu,
            Lyci, Lydi, Mahj, Mand, Mani, Mend, Merc, Mero, Mlym, Modi,
            Mong, Mroo, Mtei, Mymr, Narb, Nbat, Nkoo, Ogam, Olck, Orkh,
            Orya, Osma, Palm, Pauc, Perm, Phag, Phli, Phlp, Phnx, Plrd,
            Prti, Rjng, Runr, Samr, Sarb, Saur, Shaw, Shrd, Sidd, Sind,
            Sinh, Sora, Sund, Sylo, Syrc, Tagb, Takr, Tale, Talu, Taml,
            Tavt, Telu, Tfng, Tglg, Thaa, Thai, Tibt, Tirh, Ugar, Vaii,
        ...
        const static std::vector<std::string> value_names = {
            ...
            "Gurmukhi", "Hangul", "Han", "Hanunoo", "Hebrew", "Hiragana",
            "Pahawh_Hmong", "Katakana_Or_Hiragana", "Old_Italic",
            ...
            "Lydian", "Mahajani", "Mandaic", "Manichaean", "Mende_Kikakui",
            "Meroitic_Cursive", "Meroitic_Hieroglyphs", "Malayalam", "Modi",
            "Mongolian", "Mro", "Meetei_Mayek", "Myanmar",
            "Old_North_Arabian", "Nabataean", "Nko", "Ogham", "Ol_Chiki",
            "Old_Turkic", "Oriya", "Osmanya", "Palmyrene", "Pau_Cin_Hau",
            "Old_Permic", "Phags_Pa", "Inscriptional_Pahlavi",
            "Psalter_Pahlavi", "Phoenician", "Miao",
            "Inscriptional_Parthian", "Rejang", "Runic", "Samaritan",
            "Old_South_Arabian", "Saurashtra", "Shavian", "Sharada",
            "Siddham", "Khudawadi", "Sinhala", "Sora_Sompeng", "Sundanese",
            "Syloti_Nagri", "Syriac", "Tagbanwa", "Takri", "Tai_Le",
            "New_Tai_Lue", "Tamil", "Tai_Viet", "Telugu", "Tifinagh",
            "Tagalog", "Thaana", "Thai", "Tibetan", "Tirhuta", "Ugaritic",
            "Vai", "Warang_Citi", "Old_Persian", "Cuneiform", "Yi",
    ...
    namespace AGE_ns {
        enum value_t {
            ...
            V5_2, V6_0, V6_1, V6_2, V6_3, V7_0, Unassigned};
        const static std::vector<std::string> enum_names = {
    ...
    namespace BLK_ns {
        enum value_t {
            ...
            Dingbats, Domino, Duployan, Egyptian_Hieroglyphs, Elbasan,
            ...
            Mongolian, Mro, Music, Myanmar, Myanmar_Ext_A, Myanmar_Ext_B,
            Nabataean, NB, New_Tai_Lue, NKo, Number_Forms, OCR, Ogham,
            ...
            Pau_Cin_Hau, Phags_Pa, Phaistos, Phoenician, Phonetic_Ext,
            Phonetic_Ext_Sup, Playing_Cards, Psalter_Pahlavi, PUA,
            ...
            Tagbanwa, Tags, Tai_Le, Tai_Tham, Tai_Viet, Tai_Xuan_Jing,
        ...
        const static std::vector<std::string> enum_names = {
            ...
            "Ancient_Greek_Music", "Ancient_Greek_Numbers",
            "Ancient_Symbols", "Arabic", "Arabic_Ext_A", "Arabic_Math",
            "Arabic_PF_A", "Arabic_PF_B", "Arabic_Sup", "Armenian",
            ...
            "Chakma", "Cham", "Cherokee", "CJK", "CJK_Compat",
            "CJK_Compat_Forms", "CJK_Compat_Ideographs",
            "CJK_Compat_Ideographs_Sup", "CJK_Ext_A", "CJK_Ext_B",
            "CJK_Ext_C", "CJK_Ext_D", "CJK_Radicals_Sup", "CJK_Strokes",
            ...
            "Glagolitic", "Gothic", "Grantha", "Greek", "Greek_Ext",
            "Gujarati", "Gurmukhi", "Half_And_Full_Forms", "Half_Marks",
            ...
            "Jamo_Ext_B", "Javanese", "Kaithi", "Kana_Sup", "Kanbun",
            "Kangxi", "Kannada", "Katakana", "Katakana_Ext", "Kayah_Li",
            "Kharoshthi", "Khmer", "Khmer_Symbols", "Khojki", "Khudawadi",
            "Lao", "Latin_1_Sup", "Latin_Ext_A", "Latin_Ext_Additional",
            "Latin_Ext_B", "Latin_Ext_C", "Latin_Ext_D", "Latin_Ext_E",
            ...
            "Math_Operators", "Meetei_Mayek", "Meetei_Mayek_Ext",
            "Mende_Kikakui", "Meroitic_Cursive", "Meroitic_Hieroglyphs",
            "Miao", "Misc_Arrows", "Misc_Math_Symbols_A",
            "Misc_Math_Symbols_B", "Misc_Pictographs", "Misc_Symbols",
            ...
            "New_Tai_Lue", "NKo", "Number_Forms", "OCR", "Ogham",
            "Ol_Chiki", "Old_Italic", "Old_North_Arabian", "Old_Permic",
            "Old_Persian", "Old_South_Arabian", "Old_Turkic", "Oriya",
            "Ornamental_Dingbats", "Osmanya", "Pahawh_Hmong", "Palmyrene",
            ...
            "Sup_PUA_A", "Sup_PUA_B", "Sup_Punctuation", "Super_And_Sub",
            "Syloti_Nagri", "Syriac", "Tagalog", "Tagbanwa", "Tags",
            "Tai_Le", "Tai_Tham", "Tai_Viet", "Tai_Xuan_Jing", "Takri",
            "Tamil", "Telugu", "Thaana", "Thai", "Tibetan", "Tifinagh",
            "Tirhuta", "Transport_And_Map", "UCAS", "UCAS_Ext", "Ugaritic",
            "Vai", "Vedic_Ext", "Vertical_Forms", "VS", "VS_Sup",
        ...
        const static std::vector<std::string> value_names = {
            ...
            "Chakma", "Cham", "Cherokee", "CJK_Unified_Ideographs",
            "CJK_Compatibility", "CJK_Compatibility_Forms",
            ...
            "Domino_Tiles", "Duployan", "Egyptian_Hieroglyphs", "Elbasan",
            "Emoticons", "Enclosed_Alphanumerics",
            ...
            "Mongolian", "Mro", "Musical_Symbols", "Myanmar",
            ...
            "Ornamental_Dingbats", "Osmanya", "Pahawh_Hmong", "Palmyrene",
            "Pau_Cin_Hau", "Phags_Pa", "Phaistos_Disc", "Phoenician",
            "Phonetic_Extensions", "Phonetic_Extensions_Supplement",
            "Playing_Cards", "Psalter_Pahlavi", "Private_Use_Area",
            "General_Punctuation", "Rejang", "Rumi_Numeral_Symbols",
            "Runic", "Samaritan", "Saurashtra", "Sharada", "Shavian",
            "Shorthand_Format_Controls", "Siddham", "Sinhala",
            "Sinhala_Archaic_Numbers", "Small_Form_Variants",
            "Sora_Sompeng", "Specials", "Sundanese", "Sundanese_Supplement",
            ...
            "Superscripts_And_Subscripts", "Syloti_Nagri", "Syriac",
            "Tagalog", "Tagbanwa", "Tags", "Tai_Le", "Tai_Tham", "Tai_Viet",
            "Tai_Xuan_Jing_Symbols", "Takri", "Tamil", "Telugu", "Thaana",
    ...
    namespace INSC_ns {
        ...
        const static std::vector<std::string> enum_names = {
            ...
            "Consonant_Final", "Consonant_Head_Letter", "Consonant_Medial",
            "Consonant_Placeholder", "Consonant_Preceding_Repha",
            "Consonant_Subjoined", "Consonant_Succeeding_Repha",
            "Gemination_Mark", "Invisible_Stacker", "Joiner",
            "Modifying_Letter", "Non_Joiner", "Nukta", "Number",
            "Number_Joiner", "Other", "Pure_Killer", "Register_Shifter",
