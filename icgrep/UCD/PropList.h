...
namespace UCD {
    ...
    namespace DIA_ns {
        ...
        [0a4d, 0a4d], [0abc, 0abc], [0acd, 0acd], [0b3c, 0b3c],
        [0b4d, 0b4d], [0bcd, 0bcd], [0c4d, 0c4d], [0cbc, 0cbc],
        [0ccd, 0ccd], [0d4d, 0d4d], [0dca, 0dca], [0e47, 0e4c],
        [0e4e, 0e4e], [0ec8, 0ecc], [0f18, 0f19], [0f35, 0f35],
        [0f37, 0f37], [0f39, 0f39], [0f3e, 0f3f], [0f82, 0f84],
        [0f86, 0f87], [0fc6, 0fc6], [1037, 1037], [1039, 103a],
        [1087, 108d], [108f, 108f], [109a, 109b], [17c9, 17d3],
        [17dd, 17dd], [1939, 193b], [1a75, 1a7c], [1a7f, 1a7f],
        [1ab0, 1abd], [1b34, 1b34], [1b44, 1b44], [1b6b, 1b73],
        [1baa, 1bab], [1c36, 1c37], [1c78, 1c7d], [1cd0, 1ce8],
        [1ced, 1ced], [1cf4, 1cf4], [1cf8, 1cf9], [1d2c, 1d6a],
        [1dc4, 1dcf], [1df5, 1df5], [1dfd, 1dff], [1fbd, 1fbd],
        [1fbf, 1fc1], [1fcd, 1fcf], [1fdd, 1fdf], [1fed, 1fef],
        [1ffd, 1ffe], [2cef, 2cf1], [2e2f, 2e2f], [302a, 302f],
        [3099, 309c], [30fc, 30fc], [a66f, a66f], [a67c, a67d],
        [a67f, a67f], [a69c, a69d], [a6f0, a6f1], [a717, a721],
        [a788, a788], [a7f8, a7f9], [a8c4, a8c4], [a8e0, a8f1],
        [a92b, a92e], [a953, a953], [a9b3, a9b3], [a9c0, a9c0],
        [a9e5, a9e5], [aa7b, aa7d], [aabf, aac2], [aaf6, aaf6],
        [ab5b, ab5f], [abec, abed], [fb1e, fb1e], [fe20, fe2f],
        [ff3e, ff3e], [ff40, ff40], [ff70, ff70], [ff9e, ff9f],
        [ffe3, ffe3], [102e0, 102e0], [10ae5, 10ae6], [110b9, 110ba],
        ...
        [1172b, 1172b], [11c3f, 11c3f], [16af0, 16af4], [16f8f, 16f9f],
        [1d167, 1d169], [1d16d, 1d172], [1d17b, 1d182], [1d185, 1d18b],
        [1d1aa, 1d1ad], [1e8d0, 1e8d6], [1e944, 1e946], [1e948, 1e94a]**/
        const UnicodeSet codepoint_set 
    ...
    namespace EXT_ns {
        ...
        [115c6, 115c8], [16b42, 16b43], [16fe0, 16fe0], [1e944, 1e946]**/
        const UnicodeSet codepoint_set 
    ...
    namespace IDEO_ns {
        ...
        [4e00, 9fd5], [f900, fa6d], [fa70, fad9], [17000, 187ec],
        [18800, 18af2], [20000, 2a6d6], [2a700, 2b734], [2b740, 2b81d],
    ...
    namespace OALPHA_ns {
        ...
        [0ac7, 0ac9], [0acb, 0acc], [0ae2, 0ae3], [0b01, 0b03],
        [0b3e, 0b44], [0b47, 0b48], [0b4b, 0b4c], [0b56, 0b57],
        [0b62, 0b63], [0b82, 0b82], [0bbe, 0bc2], [0bc6, 0bc8],
        [0bca, 0bcc], [0bd7, 0bd7], [0c00, 0c03], [0c3e, 0c44],
        [0c46, 0c48], [0c4a, 0c4c], [0c55, 0c56], [0c62, 0c63],
        [0c81, 0c83], [0cbe, 0cc4], [0cc6, 0cc8], [0cca, 0ccc],
        [0cd5, 0cd6], [0ce2, 0ce3], [0d01, 0d03], [0d3e, 0d44],
        [0d46, 0d48], [0d4a, 0d4c], [0d57, 0d57], [0d62, 0d63],
        [0d82, 0d83], [0dcf, 0dd4], [0dd6, 0dd6], [0dd8, 0ddf],
        [0df2, 0df3], [0e31, 0e31], [0e34, 0e3a], [0e4d, 0e4d],
        [0eb1, 0eb1], [0eb4, 0eb9], [0ebb, 0ebc], [0ecd, 0ecd],
        [0f71, 0f81], [0f8d, 0f97], [0f99, 0fbc], [102b, 1036],
        [1038, 1038], [103b, 103e], [1056, 1059], [105e, 1060],
        [1062, 1062], [1067, 1068], [1071, 1074], [1082, 1086],
        [109c, 109d], [135f, 135f], [1712, 1713], [1732, 1733],
        [1752, 1753], [1772, 1773], [17b6, 17c8], [1885, 1886],
        [18a9, 18a9], [1920, 192b], [1930, 1938], [1a17, 1a1b],
        [1a55, 1a5e], [1a61, 1a74], [1b00, 1b04], [1b35, 1b43],
        [1b80, 1b82], [1ba1, 1ba9], [1bac, 1bad], [1be7, 1bf1],
        [1c24, 1c35], [1cf2, 1cf3], [1de7, 1df4], [24b6, 24e9],
        [2de0, 2dff], [a674, a67b], [a69e, a69f], [a823, a827],
        [a880, a881], [a8b4, a8c3], [a8c5, a8c5], [a926, a92a],
        [a947, a952], [a980, a983], [a9b4, a9bf], [aa29, aa36],
        [aa43, aa43], [aa4c, aa4d], [aab0, aab0], [aab2, aab4],
        [aab7, aab8], [aabe, aabe], [aaeb, aaef], [aaf5, aaf5],
        [abe3, abea], [fb1e, fb1e], [10376, 1037a], [10a01, 10a03],
        [10a05, 10a06], [10a0c, 10a0f], [11000, 11002], [11038, 11045],
        [11082, 11082], [110b0, 110b8], [11100, 11102], [11127, 11132],
        [11180, 11182], [111b3, 111bf], [1122c, 11234], [11237, 11237],
        [1123e, 1123e], [112df, 112e8], [11300, 11303], [1133e, 11344],
        ...
        [116ab, 116b5], [1171d, 1172a], [11c2f, 11c36], [11c38, 11c3e],
        [11c92, 11ca7], [11ca9, 11cb6], [16b30, 16b36], [16f51, 16f7e],
    ...
    namespace STERM_ns {
        ...
        [115c9, 115d7], [11641, 11642], [1173c, 1173e], [11c41, 11c42],
    ...
    namespace TERM_ns {
        ...
        [1173c, 1173e], [11c41, 11c43], [11c71, 11c71], [12470, 12474],
    ...
    namespace UIDEO_ns {
        ...
        [3400, 4db5], [4e00, 9fd5], [fa0e, fa0f], [fa11, fa11],
