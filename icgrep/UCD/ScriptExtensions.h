...
namespace UCD {
    namespace SCX_ns {
        ...
        [1600, 1600], [125184, 125258], [125264, 125273], [125278, 125279]**/
        const UnicodeSet adlm_Ext 
            {{{Empty, 50}, {Mixed, 1}, {Empty, 3861}, {Full, 2}, {Mixed, 1},
              {Empty, 30901}},
             {0x00000001, 0xc3ff07ff}};
        ...
        [1872, 1919], [2208, 2228], [2230, 2237], [2260, 2273],
        [2275, 2303], [64336, 64449], [64467, 64829], [64848, 64911],
        [64914, 64967], [65008, 65021], [65136, 65140], [65142, 65276],
        [66272, 66299], [69216, 69246], [126464, 126467], [126469, 126495],
        ...
        const UnicodeSet arab_Ext 
            {{{Empty, 48}, {Mixed, 1}, {Full, 5}, {Mixed, 1}, {Full, 1},
              ...
              {Mixed, 1}, {Empty, 91}, {Mixed, 1}, {Empty, 1788},
              {Mixed, 6}, {Empty, 1}, {Mixed, 1}, {Empty, 30856}},
             {0xcfffffdf, 0xdfffffff, 0xffff0000, 0x3fdfffff, 0xfff00000,
        ...
        [12330, 12333], [12336, 12336], [12343, 12343], [12539, 12539],
        [12549, 12589], [12704, 12730], [65093, 65094], [65377, 65381]**/
        const UnicodeSet bopo_Ext 
            {{{Empty, 23}, {Mixed, 1}, {Empty, 360}, {Mixed, 2}, {Empty, 5},
              {Mixed, 3}, {Empty, 3}, {Mixed, 1}, {Empty, 1636}, {Mixed, 1},
              {Empty, 8}, {Mixed, 1}, {Empty, 32772}},
             {0x00000c00, 0xfffbff0e, 0x00813c00, 0x08000000, 0xffffffe0,
              0x00003fff, 0x07ffffff, 0x00000060, 0x0000003e}};
        ...
        [1024, 1327], [7296, 7304], [7467, 7467], [7544, 7544],
        [11744, 11775], [11843, 11843], [42560, 42655], [65070, 65071]**/
        const UnicodeSet cyrl_Ext 
            {{{Empty, 32}, {Full, 9}, {Mixed, 1}, {Empty, 186}, {Mixed, 1},
              {Empty, 4}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 131},
              {Full, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 959}, {Full, 3},
              {Empty, 700}, {Mixed, 1}, {Empty, 32782}},
             {0x0000ffff, 0x000001ff, 0x00000800, 0x01000000, 0x00000008,
              0x0000c000}};
        ...
        [4304, 4351], [11520, 11557], [11559, 11559], [11565, 11565]**/
        const UnicodeSet geor_Ext 
            {{{Empty, 44}, {Mixed, 1}, {Empty, 88}, {Full, 1}, {Mixed, 1},
              {Full, 1}, {Empty, 224}, {Full, 1}, {Mixed, 1},
              {Empty, 34454}},
             {0x00000200, 0xffff20bf, 0x000020bf}};
        /** Code Point Ranges for Glag
        [1156, 1156], [1159, 1159], [11264, 11310], [11312, 11358],
        [11843, 11843], [42607, 42607], [122880, 122886], [122888, 122904],
        [122907, 122913], [122915, 122916], [122918, 122922]**/
        const UnicodeSet glag_Ext 
            {{{Empty, 36}, {Mixed, 1}, {Empty, 315}, {Full, 1}, {Mixed, 2},
              {Empty, 15}, {Mixed, 1}, {Empty, 960}, {Mixed, 1},
              {Empty, 2508}, {Mixed, 2}, {Empty, 30974}},
        ...
        const UnicodeSet hang_Ext 
            {{{Empty, 136}, {Full, 8}, {Empty, 240}, {Mixed, 2}, {Empty, 5},
              ...
              {Mixed, 1}, {Empty, 20}, {Full, 349}, {Mixed, 3},
        ...
        const UnicodeSet hani_Ext 
            {{{Empty, 372}, {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 6},
              ...
              {Empty, 1695}, {Mixed, 1}, {Empty, 246}, {Mixed, 1},
              {Empty, 109}, {Full, 1334}, {Mixed, 1}, {Empty, 1},
             ...
             {0xfbffffff, 0x000fffff, 0x003fffff, 0xfffbffee, 0xff813ffe,
              ...
              0x0003ffff, 0x00030000, 0x007fffff, 0x001fffff, 0x3fffffff,
        ...
        [65438, 65439], [110593, 110593], [127488, 127488]**/
        const UnicodeSet hira_Ext 
            {{{Empty, 384}, {Mixed, 3}, {Full, 1}, {Mixed, 2}, {Empty, 1},
             ...
             {0xfffbff0e, 0x30bf0000, 0xfffffffe, 0xfe7fffff, 0x00000001,
              0x18000000, 0x00000060, 0x0001003e, 0xc0000000, 0x00000002,
              0x00000001}};
        ...
        **/
        ...
        const UnicodeSet kana_Ext 
            {{{Empty, 384}, {Mixed, 2}, {Empty, 2}, {Mixed, 1}, {Full, 3},
              ...
              {Full, 1}, {Empty, 1411}, {Mixed, 1}, {Empty, 31359}},
        ...
        [2790, 2799], [70144, 70161], [70163, 70206]**/
        const UnicodeSet khoj_Ext 
            {{{Empty, 87}, {Mixed, 1}, {Empty, 2104}, {Mixed, 2},
              {Empty, 32622}},
             {0x0000ffc0, 0xfffbffff, 0x7fffffff}};
        /** Code Point Ranges for Knda
        [2385, 2386], [2404, 2405], [3200, 3203], [3205, 3212],
        [3214, 3216], [3218, 3240], [3242, 3251], [3253, 3257],
        [3260, 3268], [3270, 3272], [3274, 3277], [3285, 3286],
        [3294, 3294], [3296, 3299], [3302, 3311], [3313, 3314],
        [7386, 7386], [7413, 7413], [43056, 43061]**/
        const UnicodeSet knda_Ext 
            {{{Empty, 74}, {Mixed, 2}, {Empty, 24}, {Mixed, 4},
              {Empty, 126}, {Mixed, 2}, {Empty, 1113}, {Mixed, 1},
              {Empty, 33470}},
             {0x00060000, 0x00000030, 0xfffddfef, 0xf3effdff, 0x40603ddf,
              0x0006ffcf, 0x04000000, 0x00200000, 0x003f0000}};
        ...
        [4347, 4347], [7424, 7461], [7468, 7516], [7522, 7525],
        [7531, 7543], [7545, 7614], [7680, 7935], [8305, 8305],
        [8319, 8319], [8336, 8348], [8432, 8432], [8490, 8491],
        [8498, 8498], [8526, 8526], [8544, 8584], [11360, 11391],
        [42786, 42887], [42891, 42926], [42928, 42935], [42999, 43007],
        [43310, 43310], [43824, 43866], [43868, 43876], [64256, 64262],
        ...
        const UnicodeSet latn_Ext 
            {{{Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Full, 13},
              ...
              {Mixed, 1}, {Empty, 2}, {Full, 8}, {Empty, 11}, {Mixed, 2},
              {Empty, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Full, 1},
             ...
             {0x07fffffe, 0x07fffffe, 0x04000400, 0xff7fffff, 0xff7fffff,
              ...
              0x80020000, 0x1fff0000, 0x00010000, 0x00040c00, 0x00004000,
              0x000001ff, 0xfffffffc, 0xfffff8ff, 0x00ff7fff, 0xff800000,
              0x00004000, 0xffff0000, 0xf7ffffff, 0x0000001f, 0x0000007f,
        ...
        [3402, 3407], [3412, 3427], [3430, 3455], [7386, 7386]**/
        const UnicodeSet mlym_Ext 
            {{{Empty, 74}, {Mixed, 2}, {Empty, 28}, {Mixed, 4},
              {Empty, 122}, {Mixed, 1}, {Empty, 34585}},
             {0x00060000, 0x00000030, 0xfffddfee, 0xe7ffffff, 0xfff0fddf,
              0xffffffcf, 0x04000000}};
        ...
        const UnicodeSet mong_Ext 
            {{{Empty, 192}, {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 1},
             ...
             {0x03ff7fff, 0x00ffffff, 0x000007ff, 0x00001fff}};
        ...
        [7675, 7679], [8204, 8205], [8400, 8432], [12330, 12333],
        ...
        [1757, 1757], [2274, 2274], [2404, 2405], [3647, 3647],
        [4053, 4056], [4347, 4347], [5867, 5869], [5941, 5942],
        [6146, 6147], [6149, 6149], [7379, 7379], [7393, 7393],
        [7401, 7404], [7406, 7411], [7413, 7414], [8192, 8203],
        [8206, 8292], [8294, 8304], [8308, 8318], [8320, 8334],
        [8352, 8382], [8448, 8485], [8487, 8489], [8492, 8497],
        [8499, 8525], [8527, 8543], [8585, 8587], [8592, 9214],
        [9216, 9254], [9280, 9290], [9312, 10239], [10496, 11123],
        ...
        [118784, 119029], [119040, 119078], [119081, 119142],
        [119146, 119162], [119171, 119172], [119180, 119209],
        [119214, 119272], [119552, 119638], [119648, 119665],
        ...
        [127232, 127244], [127248, 127278], [127280, 127339],
        [127344, 127404], [127462, 127487], [127489, 127490],
        ...
        const UnicodeSet zyyy_Ext 
            {{{Full, 2}, {Mixed, 2}, {Full, 1}, {Mixed, 3}, {Empty, 13},
              ...
              {Mixed, 1}, {Empty, 1485}, {Mixed, 1}, {Empty, 154},
              {Full, 7}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 1},
              {Mixed, 3}, {Full, 1}, {Mixed, 1}, {Empty, 8}, {Full, 2},
              ...
              {Full, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 4}, {Empty, 5},
              {Full, 30}, {Mixed, 2}, {Full, 3}, {Mixed, 1}, {Full, 2},
              {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 1}, {Mixed, 1},
              {Full, 1}, {Mixed, 2}, {Empty, 2}, {Mixed, 3}, {Empty, 1},
              {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 24625},
        ...
        [2140, 2141], [2143, 2207], [2229, 2229], [2238, 2259],
        [2436, 2436], [2445, 2446], [2449, 2450], [2473, 2473],
        [2481, 2481], [2483, 2485], [2490, 2491], [2501, 2502],
        [2505, 2506], [2511, 2518], [2520, 2523], [2526, 2526],
        [2532, 2533], [2556, 2560], [2564, 2564], [2571, 2574],
        [2577, 2578], [2601, 2601], [2609, 2609], [2612, 2612],
        [2615, 2615], [2618, 2619], [2621, 2621], [2627, 2630],
        [2633, 2634], [2638, 2640], [2642, 2648], [2653, 2653],
        [2655, 2661], [2678, 2688], [2692, 2692], [2702, 2702],
        [2706, 2706], [2729, 2729], [2737, 2737], [2740, 2740],
        [2746, 2747], [2758, 2758], [2762, 2762], [2766, 2767],
        [2769, 2783], [2788, 2789], [2802, 2808], [2810, 2816],
        [2820, 2820], [2829, 2830], [2833, 2834], [2857, 2857],
        [2865, 2865], [2868, 2868], [2874, 2875], [2885, 2886],
        [2889, 2890], [2894, 2901], [2904, 2907], [2910, 2910],
        [2916, 2917], [2936, 2945], [2948, 2948], [2955, 2957],
        [2961, 2961], [2966, 2968], [2971, 2971], [2973, 2973],
        [2976, 2978], [2981, 2983], [2987, 2989], [3002, 3005],
        [3011, 3013], [3017, 3017], [3022, 3023], [3025, 3030],
        [3032, 3045], [3067, 3071], [3076, 3076], [3085, 3085],
        [3089, 3089], [3113, 3113], [3130, 3132], [3141, 3141],
        [3145, 3145], [3150, 3156], [3159, 3159], [3163, 3167],
        [3172, 3173], [3184, 3191], [3204, 3204], [3213, 3213],
        ...
        [3397, 3397], [3401, 3401], [3408, 3411], [3428, 3429],
        [3456, 3457], [3460, 3460], [3479, 3481], [3506, 3506],
        [3516, 3516], [3518, 3519], [3527, 3529], [3531, 3534],
        [3541, 3541], [3543, 3543], [3552, 3557], [3568, 3569],
        [3573, 3584], [3643, 3646], [3676, 3712], [3715, 3715],
        [3717, 3718], [3721, 3721], [3723, 3724], [3726, 3731],
        [3736, 3736], [3744, 3744], [3748, 3748], [3750, 3750],
        [3752, 3753], [3756, 3756], [3770, 3770], [3774, 3775],
        [3781, 3781], [3783, 3783], [3790, 3791], [3802, 3803],
        ...
        [6264, 6271], [6315, 6319], [6390, 6399], [6431, 6431],
        [6444, 6447], [6460, 6463], [6465, 6467], [6510, 6511],
        [6517, 6527], [6572, 6575], [6602, 6607], [6619, 6621],
        [6684, 6685], [6751, 6751], [6781, 6782], [6794, 6799],
        [6810, 6815], [6830, 6831], [6847, 6911], [6988, 6991],
        [7037, 7039], [7156, 7163], [7224, 7226], [7242, 7244],
        [7305, 7359], [7368, 7375], [7415, 7415], [7418, 7423],
        [7670, 7674], [7958, 7959], [7966, 7967], [8006, 8007],
        [8014, 8015], [8024, 8024], [8026, 8026], [8028, 8028],
        [8030, 8030], [8062, 8063], [8117, 8117], [8133, 8133],
        [8148, 8149], [8156, 8156], [8176, 8177], [8181, 8181],
        [8191, 8191], [8293, 8293], [8306, 8307], [8335, 8335],
        [8349, 8351], [8383, 8399], [8433, 8447], [8588, 8591],
        ...
        [110594, 113663], [113771, 113775], [113789, 113791],
        [113801, 113807], [113818, 113819], [113828, 118783],
        [119030, 119039], [119079, 119080], [119273, 119295],
        [119366, 119551], [119639, 119647], [119666, 119807],
        [119893, 119893], [119965, 119965], [119968, 119969],
        [119971, 119972], [119975, 119976], [119981, 119981],
        [119994, 119994], [119996, 119996], [120004, 120004],
        [120070, 120070], [120075, 120076], [120085, 120085],
        [120093, 120093], [120122, 120122], [120127, 120127],
        [120133, 120133], [120135, 120137], [120145, 120145],
        [120486, 120487], [120780, 120781], [121484, 121498],
        [121504, 121504], [121520, 122879], [122887, 122887],
        [122905, 122906], [122914, 122914], [122917, 122917],
        [122923, 124927], [125125, 125126], [125143, 125183],
        [125259, 125263], [125274, 125277], [125280, 126463],
        [126468, 126468], [126496, 126496], [126499, 126499],
        [126501, 126502], [126504, 126504], [126515, 126515],
        [126520, 126520], [126522, 126522], [126524, 126529],
        [126531, 126534], [126536, 126536], [126538, 126538],
        [126540, 126540], [126544, 126544], [126547, 126547],
        [126549, 126550], [126552, 126552], [126554, 126554],
        [126556, 126556], [126558, 126558], [126560, 126560],
        [126563, 126563], [126565, 126566], [126571, 126571],
        [126579, 126579], [126584, 126584], [126589, 126589],
        [126591, 126591], [126602, 126602], [126620, 126624],
        [126628, 126628], [126634, 126634], [126652, 126703],
        [126706, 126975], [127020, 127023], [127124, 127135],
        [127151, 127152], [127168, 127168], [127184, 127184],
        [127222, 127231], [127245, 127247], [127279, 127279],
        [127340, 127343], [127405, 127461], [127491, 127503],
        [127548, 127551], [127561, 127567], [127570, 127743],
        [128723, 128735], [128749, 128751], [128759, 128767],
        [128884, 128895], [128981, 129023], [129036, 129039],
        [129096, 129103], [129114, 129119], [129160, 129167],
        [129198, 129295], [129311, 129311], [129320, 129327],
        [129329, 129330], [129343, 129343], [129356, 129359],
        [129375, 129407], [129426, 129471], [129473, 131071],
        [173783, 173823], [177973, 177983], [178206, 178207],
        [183970, 194559], [195102, 917504], [917506, 917535],
        ...
        const UnicodeSet zzzz_Ext 
            {{{Empty, 27}, {Mixed, 3}, {Empty, 11}, {Mixed, 4}, {Empty, 1},
              ...
              {Full, 49}, {Empty, 1334}, {Mixed, 1}, {Full, 1},
              {Empty, 129}, {Mixed, 1}, {Empty, 6}, {Mixed, 1},
              {Empty, 180}, {Mixed, 1}, {Full, 330}, {Empty, 16},
       ...
       {scx,
        UCD::sc,
       {&adlm_Ext, &aghb_Ext, &ahom_Ext, &arab_Ext, &armi_Ext, &armn_Ext,
        &avst_Ext, &bali_Ext, &bamu_Ext, &bass_Ext, &batk_Ext, &beng_Ext,
        &bhks_Ext, &bopo_Ext, &brah_Ext, &brai_Ext, &bugi_Ext, &buhd_Ext,
        &cakm_Ext, &cans_Ext, &cari_Ext, &cham_Ext, &cher_Ext, &copt_Ext,
        &cprt_Ext, &cyrl_Ext, &deva_Ext, &dsrt_Ext, &dupl_Ext, &egyp_Ext,
        &elba_Ext, &ethi_Ext, &geor_Ext, &glag_Ext, &goth_Ext, &gran_Ext,
        &grek_Ext, &gujr_Ext, &guru_Ext, &hang_Ext, &hani_Ext, &hano_Ext,
        &hatr_Ext, &hebr_Ext, &hira_Ext, &hluw_Ext, &hmng_Ext, &hrkt_Ext,
        &hung_Ext, &ital_Ext, &java_Ext, &kali_Ext, &kana_Ext, &khar_Ext,
        &khmr_Ext, &khoj_Ext, &knda_Ext, &kthi_Ext, &lana_Ext, &laoo_Ext,
        &latn_Ext, &lepc_Ext, &limb_Ext, &lina_Ext, &linb_Ext, &lisu_Ext,
        &lyci_Ext, &lydi_Ext, &mahj_Ext, &mand_Ext, &mani_Ext, &marc_Ext,
        &mend_Ext, &merc_Ext, &mero_Ext, &mlym_Ext, &modi_Ext, &mong_Ext,
        &mroo_Ext, &mtei_Ext, &mult_Ext, &mymr_Ext, &narb_Ext, &nbat_Ext,
        &newa_Ext, &nkoo_Ext, &ogam_Ext, &olck_Ext, &orkh_Ext, &orya_Ext,
        &osge_Ext, &osma_Ext, &palm_Ext, &pauc_Ext, &perm_Ext, &phag_Ext,
        &phli_Ext, &phlp_Ext, &phnx_Ext, &plrd_Ext, &prti_Ext, &rjng_Ext,
        &runr_Ext, &samr_Ext, &sarb_Ext, &saur_Ext, &sgnw_Ext, &shaw_Ext,
        &shrd_Ext, &sidd_Ext, &sind_Ext, &sinh_Ext, &sora_Ext, &sund_Ext,
        &sylo_Ext, &syrc_Ext, &tagb_Ext, &takr_Ext, &tale_Ext, &talu_Ext,
        &taml_Ext, &tang_Ext, &tavt_Ext, &telu_Ext, &tfng_Ext, &tglg_Ext,
