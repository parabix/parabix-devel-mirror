...
namespace UCD {
  namespace NT_ns {
    ...
    {Full, 1}, {Mixed, 1}, {Full, 9}, {Mixed, 1}, {Full, 11}, {Mixed, 1},
    {Full, 14}, {Mixed, 2}, {Full, 3}, {Mixed, 1}, {Full, 1}, {Mixed, 1},
    {Full, 4}, {Mixed, 2}, {Full, 7}, {Mixed, 1}, {Full, 10}, {Mixed, 1},
    {Full, 3}, {Mixed, 1}, {Full, 11}, {Mixed, 1}, {Full, 3}, {Mixed, 1},
    {Full, 2}, {Mixed, 1}, {Full, 13}, {Mixed, 1}, {Full, 26}, {Mixed, 2},
    {Full, 6}, {Mixed, 1}, {Full, 53}, {Empty, 3}, {Mixed, 1}, {Full, 559},
    {Mixed, 1}, {Full, 6}, {Mixed, 2}, {Full, 831}, {Mixed, 1}, {Full, 34},
    {Mixed, 1}, {Empty, 1}, {Full, 134}, {Mixed, 1}, {Full, 3}, {Mixed, 1},
    {Full, 61}, {Mixed, 1}, {Full, 119}, {Mixed, 1}, {Full, 2}, {Mixed, 1},
    ...
    0xffff007f, 0x07ffffff, 0xf03fffff, 0xcfffffff, 0x00030000, 0xffffff00,
    0x9fffffff, 0x1fffffff, 0xffff07ff, 0x00ffffff, 0x00ffffff, 0xffff01ff,
    0x03ffffff, 0x80000000, 0x0003ffff, 0xffff0000, 0xfc00ffff, 0x003fffff,
    0xfc00ffff, 0xffe00001, 0xfc00ffff, 0xfc00ffff, 0xfc00ffff, 0xfc00ffff,
    0xfffffc00, 0xf000ffff, 0xfff80000, 0x0000ffff, 0xffffe000, 0xfc00ffff,
    0xffff8000, 0xfffffc00, 0x0400ffff, 0xfffffffc, 0xfffc0000, 0x00003fff,
    0xffff007f, 0xfc00ffff, 0xffffe000, 0xfffffffd, 0xffffffef, 0xfffffffb,
    0xfffffffd, 0xfffffbff, 0xefffeff7, 0xdffffbff, 0xfdffffff, 0xfffeffff,
    0xfeffffff, 0xf7ffffff, 0xffffdfff, 0xfffeffff};
    }

    const static UnicodeSet none_Set{const_cast<UnicodeSet::run_t *>(__none_Set_runs), 261, 0, const_cast<UnicodeSet::bitquad_t *>(__none_Set_quads), 160, 0};
    ...
    {Empty, 9}, {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 14},
    {Mixed, 2}, {Empty, 11}, {Mixed, 1}, {Empty, 41}, {Mixed, 1},
    {Empty, 13}, {Mixed, 1}, {Empty, 26}, {Mixed, 2}, {Empty, 60},
    {Full, 3}, {Mixed, 1}, {Empty, 566}, {Mixed, 2}, {Empty, 831},
    {Mixed, 1}, {Empty, 170}, {Mixed, 1}, {Empty, 65}, {Mixed, 1},
    {Empty, 119}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 3},
    {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 63}, {Mixed, 1}, {Empty, 2},
    ...
    0x0000ff80, 0xf8000000, 0x0fc00000, 0x30000000, 0xfffcffff, 0x000000f0,
    0x60000000, 0xe0000000, 0x0000f800, 0xff000000, 0xff000000, 0x0000fe00,
    0xfc000000, 0x7ffffe00, 0xf8000000, 0x0000003f, 0x001ffffe, 0x0c000000,
    0x0007fc00, 0xfc000000, 0x00001fff, 0x00007fff, 0xf8000000, 0x00000003,
    0x0003ffff, 0x0000ff80, 0x00001800, 0x00000002, 0x00000010, 0x00000004,
    0x00000002, 0x00000400, 0x10001008, 0x20000400, 0x02000000, 0x00010000,
    0x01000000, 0x08000000, 0x00002000, 0x00010000};
    }

    const static UnicodeSet nu_Set{const_cast<UnicodeSet::run_t *>(__nu_Set_runs), 181, 0, const_cast<UnicodeSet::bitquad_t *>(__nu_Set_quads), 118, 0};
    ...
    const static UnicodeSet de_Set{const_cast<UnicodeSet::run_t *>(__de_Set_runs), 104, 0, const_cast<UnicodeSet::bitquad_t *>(__de_Set_quads), 53, 0};
