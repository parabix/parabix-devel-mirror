...
namespace UCD {
    enum property_t {
        ...
        gc, GCB, hst, InMC, InSC, jg, jt, lb, NFC_QC, NFD_QC, NFKC_QC,
    ...
    const static std::vector<std::string> property_enum_name = {
        ...
        "hst", "InMC", "InSC", "jg", "jt", "lb", "NFC_QC", "NFD_QC",
    ...
    const static std::vector<std::string> property_full_name = {
        ...
        "Hangul_Syllable_Type", "Indic_Matra_Category",
    ...
    static std::unordered_map<std::string, int> alias_map {{
        ...
        {"inmc", InMC}, {"insc", InSC}, {"isc", isc}, {"isocomment", isc},
