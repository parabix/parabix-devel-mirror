    ...
    namespace ALPHA_ns {
        ...
        const UnicodeSet codepoint_set 
            {{{Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Full, 14},
              ...
              {Mixed, 3}, {Full, 1}, {Mixed, 3}, {Full, 1}, {Mixed, 7},
              ...
              {Full, 1}, {Mixed, 1}, {Empty, 24}, {Full, 2}, {Mixed, 1},
              {Empty, 1}, {Mixed, 4}, {Full, 1}, {Mixed, 3}, {Full, 2},
              {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Empty, 2}, {Mixed, 2},
              {Full, 1}, {Mixed, 5}, {Empty, 4}, {Full, 2}, {Mixed, 1},
              {Empty, 1}, {Full, 2}, {Mixed, 1}, {Empty, 5}, {Full, 1},
              {Mixed, 2}, {Empty, 1}, {Full, 1}, {Mixed, 2}, {Empty, 1},
              {Full, 1}, {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 11},
              {Full, 2}, {Mixed, 1}, {Empty, 8}, {Full, 1}, {Mixed, 2},
              {Full, 1}, {Mixed, 1}, {Empty, 1}, {Full, 1}, {Mixed, 1},
              {Empty, 8}, {Mixed, 6}, {Empty, 2}, {Mixed, 3}, {Empty, 21},
              ...
              {Mixed, 2}, {Empty, 62}, {Full, 6}, {Mixed, 1}, {Empty, 1},
    ...
    namespace CI_ns {
        ...
        const UnicodeSet codepoint_set 
            {{{Empty, 1}, {Mixed, 3}, {Empty, 1}, {Mixed, 1}, {Empty, 15},
              ...
              {Empty, 2}, {Mixed, 1}, {Empty, 612}, {Mixed, 2},
    ...
    namespace GR_BASE_ns {
        ...
        const UnicodeSet codepoint_set 
            {{{Empty, 1}, {Full, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
              ...
              {Mixed, 5}, {Full, 2}, {Mixed, 1}, {Full, 1}, {Mixed, 5},
              {Empty, 1}, {Mixed, 1}, {Empty, 2}, {Mixed, 43}, {Empty, 1},
              ...
              {Full, 1}, {Mixed, 5}, {Full, 1}, {Mixed, 2}, {Full, 1},
              {Empty, 2}, {Full, 4}, {Mixed, 1}, {Full, 20}, {Mixed, 2},
              {Full, 56}, {Mixed, 5}, {Full, 1}, {Mixed, 2}, {Full, 4},
              {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 1}, {Mixed, 4},
              {Empty, 1}, {Full, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
              {Full, 2}, {Mixed, 1}, {Full, 6}, {Mixed, 2}, {Full, 1},
              {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 3}, {Mixed, 2},
              {Full, 2}, {Mixed, 2}, {Full, 1}, {Mixed, 2}, {Full, 6},
              {Mixed, 1}, {Full, 213}, {Mixed, 1}, {Full, 657}, {Mixed, 1},
              {Full, 36}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 10},
              {Mixed, 1}, {Full, 1}, {Mixed, 2}, {Full, 2}, {Mixed, 1},
              {Full, 5}, {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Full, 1},
              {Mixed, 1}, {Full, 2}, {Mixed, 2}, {Full, 1}, {Mixed, 7},
              {Full, 1}, {Mixed, 3}, {Full, 1}, {Mixed, 5}, {Full, 1},
              ...
              {Full, 1}, {Mixed, 1}, {Empty, 1}, {Full, 4}, {Mixed, 4},
              {Full, 1}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Empty, 4},
              {Full, 9}, {Mixed, 3}, {Empty, 4}, {Mixed, 3}, {Full, 1},
              {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Empty, 2}, {Full, 1},
              {Mixed, 2}, {Full, 1}, {Mixed, 3}, {Full, 2}, {Empty, 1},
              {Full, 1}, {Mixed, 1}, {Full, 1}, {Mixed, 5}, {Empty, 2},
              {Full, 2}, {Mixed, 1}, {Empty, 1}, {Full, 1}, {Mixed, 1},
              {Full, 1}, {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 12},
              {Mixed, 18}, {Empty, 2}, {Mixed, 8}, {Empty, 4}, {Full, 1},
              {Mixed, 2}, {Empty, 1}, {Full, 1}, {Mixed, 2}, {Empty, 5},
              {Full, 1}, {Mixed, 2}, {Empty, 1}, {Full, 1}, {Mixed, 3},
              {Full, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Empty, 11},
              {Full, 2}, {Mixed, 1}, {Empty, 8}, {Mixed, 3}, {Full, 1},
              {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Empty, 8}, {Mixed, 6},
              {Empty, 2}, {Mixed, 3}, {Empty, 21}, {Full, 28}, {Mixed, 1},
              ...
              {Empty, 1}, {Mixed, 2}, {Empty, 107}, {Full, 6}, {Mixed, 1},
              ...
              {Empty, 48}, {Full, 1334}, {Mixed, 1}, {Empty, 1},
    ...
    namespace GR_EXT_ns {
        ...
        const UnicodeSet codepoint_set 
            {{{Empty, 24}, {Full, 3}, {Mixed, 1}, {Empty, 8}, {Mixed, 1},
              ...
              {Empty, 615}, {Mixed, 1}, {Empty, 166}, {Mixed, 3},
              {Empty, 4}, {Mixed, 1}, {Empty, 61}, {Full, 1}, {Mixed, 1},
              {Full, 1}, {Mixed, 3}, {Empty, 42}, {Mixed, 2}, {Empty, 68},
    ...
    namespace IDC_ns {
        ...
        const UnicodeSet codepoint_set 
            {{{Empty, 1}, {Mixed, 3}, {Empty, 1}, {Mixed, 3}, {Full, 14},
              ...
              {Mixed, 3}, {Empty, 1}, {Mixed, 3}, {Full, 3}, {Mixed, 30},
              {Full, 1}, {Mixed, 9}, {Empty, 1}, {Mixed, 3}, {Empty, 1},
              ...
              {Full, 205}, {Mixed, 1}, {Empty, 2}, {Full, 655}, {Mixed, 1},
              {Full, 36}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Full, 8},
              {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 3}, {Mixed, 3},
              {Full, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Full, 1},
              {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 2}, {Mixed, 2},
              {Full, 1}, {Mixed, 3}, {Full, 2}, {Mixed, 2}, {Full, 1},
              {Mixed, 3}, {Full, 2}, {Mixed, 6}, {Full, 3}, {Mixed, 1},
              {Full, 349}, {Mixed, 3}, {Empty, 264}, {Full, 11}, {Mixed, 1},
              {Full, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Full, 2},
              {Mixed, 2}, {Full, 10}, {Mixed, 2}, {Full, 1}, {Mixed, 1},
              {Full, 1}, {Mixed, 6}, {Full, 3}, {Mixed, 5}, {Full, 1},
              ...
              {Empty, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 4}, {Empty, 3},
              {Full, 2}, {Mixed, 1}, {Empty, 1}, {Full, 1}, {Mixed, 1},
              {Full, 1}, {Mixed, 1}, {Empty, 24}, {Full, 2}, {Mixed, 2},
              ...
              {Mixed, 1}, {Empty, 96}, {Full, 16}, {Mixed, 1},
    ...
    namespace IDS_ns {
        ...
        const UnicodeSet codepoint_set 
            {{{Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Full, 14},
              ...
              {Empty, 2}, {Mixed, 1}, {Empty, 12}, {Full, 2}, {Mixed, 1},
              {Empty, 8}, {Mixed, 3}, {Full, 1}, {Mixed, 1}, {Empty, 1},
    ...
    namespace XIDC_ns {
        ...
        const UnicodeSet codepoint_set 
            {{{Empty, 1}, {Mixed, 3}, {Empty, 1}, {Mixed, 3}, {Full, 14},
              ...
              {Full, 349}, {Mixed, 3}, {Empty, 264}, {Full, 11}, {Mixed, 1},
              {Full, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Full, 2},
              {Mixed, 2}, {Full, 3}, {Mixed, 2}, {Full, 5}, {Mixed, 2},
              ...
              {Mixed, 2}, {Empty, 11}, {Full, 2}, {Mixed, 1}, {Empty, 8},
              {Full, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Empty, 1},
