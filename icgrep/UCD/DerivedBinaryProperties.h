...
namespace UCD {
    namespace BIDI_M_ns {
        ...
        [2983, 2998], [299b, 29af], [29b8, 29b8], [29c0, 29c5],
        [29c9, 29c9], [29ce, 29d2], [29d4, 29d5], [29d8, 29dc],
        [29e1, 29e1], [29e3, 29e5], [29e8, 29e9], [29f4, 29f9],
        [29fc, 29fd], [2a0a, 2a1c], [2a1e, 2a21], [2a24, 2a24],
        [2a26, 2a26], [2a29, 2a29], [2a2b, 2a2e], [2a34, 2a35],
        [2a3c, 2a3e], [2a57, 2a58], [2a64, 2a65], [2a6a, 2a6d],
        [2a6f, 2a70], [2a73, 2a74], [2a79, 2aa3], [2aa6, 2aad],
        [2aaf, 2ad6], [2adc, 2adc], [2ade, 2ade], [2ae2, 2ae6],
        [2aec, 2aee], [2af3, 2af3], [2af7, 2afb], [2afd, 2afd],
        [2e02, 2e05], [2e09, 2e0a], [2e0c, 2e0d], [2e1c, 2e1d],
        [2e20, 2e29], [3008, 3011], [3014, 301b], [fe59, fe5e],
        [fe64, fe65], [ff08, ff09], [ff1c, ff1c], [ff1e, ff1e],
        [ff3b, ff3b], [ff3d, ff3d], [ff5b, ff5b], [ff5d, ff5d],
        [ff5f, ff60], [ff62, ff63], [1d6db, 1d6db], [1d715, 1d715],
        [1d74f, 1d74f], [1d789, 1d789], [1d7c3, 1d7c3]**/
        ...
        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 41, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 49, 0};
