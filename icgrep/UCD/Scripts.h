...
namespace UCD {
    ...
    [2208, 2228], [2275, 2303], [64336, 64449], [64467, 64829],
    [64848, 64911], [64914, 64967], [65008, 65021], [65136, 65140],
    [65142, 65276], [69216, 69246], [126464, 126467], [126469, 126495],
    ...
    const UnicodeSet arab_Set 
        {{{Empty, 48}, {Mixed, 1}, {Full, 1}, {Mixed, 2}, {Full, 2},
         ...
         {0x47ffefdf, 0xffc007fe, 0xfffeffff, 0xdfffffff, 0xffff0000,
          0x001fffff, 0xfffffff8, 0xffff0000, 0xfff80003, 0x3fffffff,
    ...
    const UnicodeSet cyrl_Set 
        {{{Empty, 32}, {Full, 4}, {Mixed, 1}, {Full, 4}, {Mixed, 1},
          ...
          {Full, 1}, {Empty, 962}, {Full, 3}, {Empty, 700}, {Mixed, 1},
          {Empty, 32782}},
         {0xffffff9f, 0x0000ffff, 0x00000800, 0x01000000, 0x0000c000}};
    ...
    **/
    ...
    [11360, 11391], [42786, 42887], [42891, 42925], [42928, 42935],
    ...
    const UnicodeSet latn_Set 
        {{{Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Full, 13},
         ...
         {0x07fffffe, 0x07fffffe, 0x04000400, 0xff7fffff, 0xff7fffff,
          ...
          0x000001ff, 0xfffffffc, 0xfffff8ff, 0x00ff3fff, 0xff800000,
    ...
    [3398, 3400], [3402, 3406], [3415, 3415], [3423, 3427], [3430, 3445],
    [3449, 3455]**/
    ...
    [1563, 1564], [1567, 1567], [1600, 1600], [1757, 1757], [2404, 2405],
    [3647, 3647], [4053, 4056], [4347, 4347], [5867, 5869], [5941, 5942],
    [6146, 6147], [6149, 6149], [7379, 7379], [7393, 7393], [7401, 7404],
    [7406, 7411], [7413, 7414], [8192, 8203], [8206, 8292], [8294, 8304],
    [8308, 8318], [8320, 8334], [8352, 8382], [8448, 8485], [8487, 8489],
    [8492, 8497], [8499, 8525], [8527, 8543], [8585, 8587], [8592, 9210],
    [9216, 9254], [9280, 9290], [9312, 10239], [10496, 11123],
    [11126, 11157], [11160, 11193], [11197, 11208], [11210, 11217],
    [11244, 11247], [11776, 11842], [12272, 12283], [12288, 12292],
    ...
    [127232, 127244], [127248, 127278], [127280, 127339], [127344, 127386],
    [127462, 127487], [127489, 127490], [127504, 127546], [127552, 127560],
    [127568, 127569], [127744, 128377], [128379, 128419], [128421, 128720],
    ...
    static EnumeratedPropertyObject property_object
        {sc,
         ...
         {&aghb_Set, &ahom_Set, &arab_Set, &armi_Set, &armn_Set, &avst_Set,
        &bali_Set, &bamu_Set, &bass_Set, &batk_Set, &beng_Set, &bopo_Set,
        &brah_Set, &brai_Set, &bugi_Set, &buhd_Set, &cakm_Set, &cans_Set,
        &cari_Set, &cham_Set, &cher_Set, &copt_Set, &cprt_Set, &cyrl_Set,
        &deva_Set, &dsrt_Set, &dupl_Set, &egyp_Set, &elba_Set, &ethi_Set,
        &geor_Set, &glag_Set, &goth_Set, &gran_Set, &grek_Set, &gujr_Set,
        &guru_Set, &hang_Set, &hani_Set, &hano_Set, &hatr_Set, &hebr_Set,
        &hira_Set, &hluw_Set, &hmng_Set, &hrkt_Set, &hung_Set, &ital_Set,
        &java_Set, &kali_Set, &kana_Set, &khar_Set, &khmr_Set, &khoj_Set,
        &knda_Set, &kthi_Set, &lana_Set, &laoo_Set, &latn_Set, &lepc_Set,
        &limb_Set, &lina_Set, &linb_Set, &lisu_Set, &lyci_Set, &lydi_Set,
        &mahj_Set, &mand_Set, &mani_Set, &mend_Set, &merc_Set, &mero_Set,
        &mlym_Set, &modi_Set, &mong_Set, &mroo_Set, &mtei_Set, &mult_Set,
        &mymr_Set, &narb_Set, &nbat_Set, &nkoo_Set, &ogam_Set, &olck_Set,
        &orkh_Set, &orya_Set, &osma_Set, &palm_Set, &pauc_Set, &perm_Set,
        &phag_Set, &phli_Set, &phlp_Set, &phnx_Set, &plrd_Set, &prti_Set,
        &rjng_Set, &runr_Set, &samr_Set, &sarb_Set, &saur_Set, &sgnw_Set,
