...
namespace UCD {
  namespace VO_ns {
    ...
    const UnicodeSet r_Set 
        {{{Full, 5}, {Mixed, 3}, {Full, 15}, {Mixed, 1}, {Full, 112},
          {Empty, 8}, {Full, 16}, {Mixed, 1}, {Empty, 19}, {Full, 17},
          {Mixed, 1}, {Empty, 2}, {Full, 56}, {Mixed, 4}, {Full, 2},
          {Mixed, 5}, {Empty, 1}, {Mixed, 1}, {Full, 3}, {Mixed, 2},
          {Full, 6}, {Mixed, 2}, {Full, 1}, {Mixed, 5}, {Empty, 1},
          {Mixed, 1}, {Empty, 6}, {Full, 5}, {Empty, 3}, {Mixed, 1},
          {Empty, 10}, {Mixed, 2}, {Full, 27}, {Mixed, 3}, {Full, 2},
          {Mixed, 3}, {Full, 20}, {Empty, 946}, {Mixed, 1}, {Full, 36},
          {Empty, 1}, {Full, 20}, {Empty, 352}, {Full, 64}, {Empty, 216},
          {Full, 24}, {Mixed, 4}, {Full, 4}, {Mixed, 1}, {Empty, 2},
          {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Full, 76}, {Empty, 1},
          {Full, 95}, {Empty, 4}, {Full, 32}, {Empty, 5}, {Mixed, 1},
          {Full, 170}, {Empty, 33}, {Mixed, 1}, {Full, 126}, {Empty, 20},
          {Full, 331}, {Empty, 217}, {Full, 296}, {Empty, 9}, {Mixed, 1},
          {Full, 1}, {Mixed, 1}, {Empty, 12}, {Full, 232}, {Empty, 16},
          {Full, 8}, {Empty, 4}, {Full, 36}, {Empty, 21}, {Mixed, 1},
          {Full, 170}, {Empty, 64}, {Full, 8}, {Empty, 8}, {Full, 48},
          {Empty, 2047}, {Mixed, 1}, {Empty, 2047}, {Mixed, 1},
          {Full, 22528}, {Empty, 2047}, {Mixed, 1}, {Empty, 2047},
          {Mixed, 1}},
         {0x8ffdbd7f, 0xff7fffff, 0xff7fffff, 0xfffff3ff, 0x00000001,
          0x0000ffff, 0xffbfffff, 0xe7fcfffc, 0xfffdfc7b, 0xffffffdf,
          0x1fffffff, 0xffffffe2, 0x3f277c04, 0x001fbd50, 0x0000481f,
          0xffff0c00, 0xbfffffff, 0xffcfffff, 0x00000f00, 0xfffff00f,
          0x1fffffff, 0xf8000000, 0x3fffffff, 0xf0014000, 0x00000003,
          0x00000008, 0xfc000000, 0x003fff00, 0xfff00000, 0x0003ffff,
          0xffff0000, 0xfc00ffff, 0x00ffffff, 0x00040000, 0x0000f000,
          0xffff0000, 0x0000ffff, 0x0000ffff, 0x0100fe00, 0xffff0078,
          0x70002001, 0xfffffffe, 0xce00ff00, 0xffff0000, 0xffff0000,
          0xffff0000, 0x0000ffff, 0xffff0000, 0xc0000000, 0xc0000000,
    ...
    const UnicodeSet u_Set 
        {{{Empty, 5}, {Mixed, 3}, {Empty, 15}, {Mixed, 1}, {Empty, 112},
          {Full, 8}, {Empty, 16}, {Mixed, 1}, {Full, 19}, {Empty, 17},
          {Mixed, 1}, {Full, 2}, {Empty, 56}, {Mixed, 4}, {Empty, 2},
          {Mixed, 5}, {Full, 1}, {Mixed, 1}, {Empty, 3}, {Mixed, 2},
          {Empty, 6}, {Mixed, 2}, {Empty, 1}, {Mixed, 5}, {Full, 1},
          {Mixed, 1}, {Full, 6}, {Empty, 5}, {Full, 3}, {Mixed, 1},
          {Full, 10}, {Mixed, 2}, {Empty, 27}, {Mixed, 3}, {Empty, 2},
          {Mixed, 3}, {Empty, 20}, {Full, 12}, {Mixed, 8}, {Full, 1},
          {Mixed, 1}, {Full, 5}, {Mixed, 1}, {Full, 8}, {Empty, 2},
          {Mixed, 2}, {Full, 906}, {Mixed, 1}, {Empty, 36}, {Full, 1},
          {Empty, 20}, {Full, 352}, {Empty, 64}, {Full, 216}, {Empty, 24},
          {Mixed, 4}, {Empty, 4}, {Mixed, 3}, {Empty, 4}, {Mixed, 1},
          {Empty, 76}, {Full, 1}, {Empty, 95}, {Full, 4}, {Empty, 32},
          {Full, 5}, {Mixed, 1}, {Empty, 170}, {Full, 33}, {Mixed, 1},
          {Empty, 126}, {Full, 20}, {Empty, 331}, {Full, 217}, {Empty, 296},
          {Full, 9}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 12},
          ...
          {Mixed, 1}, {Full, 2047}, {Mixed, 1}, {Empty, 22528},
          {Full, 2047}, {Mixed, 1}, {Full, 2047}, {Mixed, 1}},
         {0x70024280, 0x00800000, 0x00800000, 0x00000c00, 0xfffffffe,
          0xffff0000, 0x00400000, 0x18030003, 0x00020384, 0x00000020,
          0xe0000000, 0x0000001d, 0xc0d883fb, 0xffe042af, 0xffffb7e0,
          0x0000f3ff, 0x40000000, 0x00300000, 0xfffff0ff, 0x000009f0,
          0xe0000000, 0x07ffffff, 0xc0000000, 0x0ffebfff, 0xfffffffc,
          0xfffffff7, 0x03ffffff, 0xffc000ff, 0x000fffff, 0xfffc0000,
          0x0000ffff, 0x03ff0000, 0xff000000, 0xfffbffff, 0xffff0fff,
          0x000c00f9, 0xfffeffff, 0xfffffd55, 0xfffffff7, 0xe79fbf57,
          0xfffffd54, 0xfffffff7, 0xef9fbf57, 0xffffff7f, 0x0000ffff,
          0xff000000, 0x07ffffff, 0x0000ffff, 0xffff0000, 0xffff0000,
          0x80f801ff, 0x0000ff87, 0x03ff8cfc, 0x57ffffff, 0x07ffffff,
          0x31ff00f7, 0x0000ffff, 0x0000ffff, 0x0000ffff, 0xffff0000,
          0x0000ffff, 0xfffffffc, 0x3fffffff, 0x3fffffff, 0x3fffffff,
          0x3fffffff}};
    ...
    const UnicodeSet tr_Set 
        {{{Empty, 281}, {Mixed, 1}, {Empty, 102}, {Mixed, 2}, {Empty, 3},
         ...
         {0x00000600, 0xfff3ff00, 0x00010000, 0x00000001, 0x10000000,
          0x7e000000, 0x0c000300, 0xa8000000, 0xf8000000, 0x00000001,
          0x00000008}};
    ...
    const UnicodeSet tu_Set 
        {{{Empty, 384}, {Mixed, 1}, {Empty, 1}, {Mixed, 6}, {Empty, 1},
          {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 8}, {Full, 2},
          {Mixed, 2}, {Empty, 1622}, {Mixed, 1}, {Empty, 5}, {Mixed, 1},
          {Empty, 1943}, {Mixed, 1}, {Empty, 30831}},
         {0x00000006, 0x000002aa, 0x00000008, 0x186040a8, 0x000002aa,
          0x00000008, 0x006040a8, 0x00000080, 0xffff0000, 0x00ffffff,
          0xf8000000, 0x00070000, 0x80005002, 0x00000003}};
    static EnumeratedPropertyObject property_object
        {vo,
         VO_ns::independent_prop_values,
         VO_ns::enum_names,
         VO_ns::value_names,
         VO_ns::aliases_only_map,
