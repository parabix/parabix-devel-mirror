...
public:
    UTF8fieldDepositMask(BuilderRef b, kernel::StreamSet * u32basis, kernel::StreamSet * u8fieldMask, kernel::StreamSet * u8unitCounts, bool u16u8 = false, unsigned depositFieldWidth = sizeof(size_t) * 8);
private:
