...
namespace UCD {
  namespace JT_ns {
    ...
    [082e, 083f], [0856, 0858], [085c, 085f], [0861, 0861], [0866, 0866],
    [086b, 089f], [08ad, 08ad], [08b5, 08b5], [08be, 08d2], [08e2, 08e2],
    ...
    [0b40, 0b40], [0b45, 0b4c], [0b4e, 0b55], [0b57, 0b61], [0b64, 0b81],
    [0b83, 0bbf], [0bc1, 0bcc], [0bce, 0bff], [0c01, 0c03], [0c05, 0c3d],
    [0c41, 0c45], [0c49, 0c49], [0c4e, 0c54], [0c57, 0c61], [0c64, 0c80],
    [0c82, 0cbb], [0cbd, 0cbe], [0cc0, 0cc5], [0cc7, 0ccb], [0cce, 0ce1],
    [0ce4, 0cff], [0d02, 0d3a], [0d3d, 0d40], [0d45, 0d4c], [0d4e, 0d61],
    [0d64, 0dc9], [0dcb, 0dd1], [0dd5, 0dd5], [0dd7, 0e30], [0e32, 0e33],
    [0e3b, 0e46], [0e4f, 0eb0], [0eb2, 0eb3], [0eba, 0eba], [0ebd, 0ec7],
    [0ece, 0f17], [0f1a, 0f34], [0f36, 0f36], [0f38, 0f38], [0f3a, 0f70],
    ...
    [108e, 109c], [109e, 135c], [1360, 1711], [1715, 1731], [1735, 1751],
    [1754, 1771], [1774, 17b3], [17b6, 17b6], [17be, 17c5], [17c7, 17c8],
    [17d4, 17dc], [17de, 1806], [1808, 1809], [180e, 181f], [1879, 1884],
    [18ab, 191f], [1923, 1926], [1929, 1931], [1933, 1938], [193c, 1a16],
    ...
    [1cf5, 1cf7], [1cfa, 1dbf], [1dfa, 1dfa], [1e00, 200a], [200c, 200c],
    [2010, 2029], [202f, 205f], [2065, 2069], [2070, 20cf], [20f1, 2cee],
    [2cf2, 2d7e], [2d80, 2ddf], [2e00, 3029], [302e, 3098], [309b, a66e],
    [a673, a673], [a67e, a69d], [a6a0, a6ef], [a6f2, a801], [a803, a805],
    [a807, a80a], [a80c, a824], [a827, a83f], [a873, a8c3], [a8c6, a8df],
    ...
    [10d28, 10f2f], [10f45, 10f45], [10f55, 11000], [11002, 11037],
    [11047, 1107e], [11082, 110b2], [110b7, 110b8], [110bb, 110ff],
    ...
    [116b8, 1171c], [11720, 11721], [11726, 11726], [1172c, 1182e],
    [11838, 11838], [1183b, 11a00], [11a0b, 11a32], [11a39, 11a3a],
    ...
    [11d98, 11ef2], [11ef5, 16aef], [16af5, 16b2f], [16b37, 16f8e],
    [16f93, 1bc9c], [1bc9f, 1bc9f], [1bca4, 1d166], [1d16a, 1d172],
    ...
    [1e022, 1e022], [1e025, 1e025], [1e02b, 1e8cf], [1e8d7, 1e8ff],
    [1e94b, e0000], [e0002, e001f], [e0080, e00ff], [e01f0, 10ffff]**/
    ...
    {Empty, 1}, {Mixed, 1}, {Full, 15}, {Mixed, 2}, {Full, 5}, {Mixed, 6},
    {Full, 2}, {Mixed, 2}, {Full, 1}, {Mixed, 4}, {Full, 2}, {Mixed, 1},
    {Full, 4}, {Mixed, 6}, {Full, 5}, {Mixed, 2}, {Full, 2}, {Mixed, 2},
    {Full, 6}, {Mixed, 2}, {Full, 2}, {Mixed, 2}, {Full, 2}, {Mixed, 1},
    {Full, 2}, {Mixed, 2}, {Full, 7}, {Mixed, 1}, {Full, 14}, {Mixed, 3},
    {Full, 1}, {Mixed, 1}, {Full, 12}, {Mixed, 1}, {Full, 2}, {Mixed, 2},
    {Full, 3}, {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 10}, {Mixed, 1},
    {Full, 607}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 34}, {Mixed, 1},
    {Full, 615}, {Mixed, 2}, {Full, 165}, {Mixed, 3}, {Full, 4}, {Mixed, 1},
    {Full, 61}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Full, 42},
    {Mixed, 2}, {Full, 68}, {Mixed, 1}, {Full, 1}, {Empty, 2}, {Mixed, 1},
    ...
    0xf1c00000, 0xfffff842, 0xc0202000, 0x0007ffff, 0x00000004, 0xfffffff8,
    ...
    0xdff001bf, 0xffffc37f, 0xfe000000, 0x0000001f, 0xfffff800, 0xf1fbfe78,
    ...
    0x00001940, 0xffff078c, 0xfffc0000, 0xffff81ff, 0xffffff00, 0x0000ffff,
    0xffe00020, 0xfffffffd, 0x00ffffff, 0xffffff80, 0x7fffffff, 0xfffffffc,
    0xf987ffff, 0xfffffff8, 0xffe0107f, 0xfff7ffff, 0xfffffffc, 0x803fffff,
    0xffffe1ff, 0xbf2c7fff, 0x7fffffff, 0xfffff807, 0xfffffffc, 0xe7ffffff,
    0xfffffffe, 0xffe0e03f, 0x00ffffff, 0xbfffffa3, 0x7a07ffff, 0xfffffff2,
    0x4fc3ffff, 0xcffffffe, 0x5807ffff, 0xfffffffe, 0xff40d7ff, 0x1fffffff,
    0xfffff043, 0xf9007fff, 0xfffff801, 0x8607ffff, 0xf181ff7f, 0xfc8003ff,
    0x4080ffff, 0x0003ffff, 0xff920300, 0x4b81ffff, 0xffffff40, 0xff5cffff,
    0xffe7ffff, 0xffe0ffff, 0xff80ffff, 0xfff87fff, 0x9fffffff, 0xfffffff0,
    ...
    const static UnicodeSet u_Set{const_cast<UnicodeSet::run_t *>(__u_Set_runs), 199, 0, const_cast<UnicodeSet::bitquad_t *>(__u_Set_quads), 206, 0};
    ...
    [08ba, 08bd], [1807, 1807], [1820, 1878], [1887, 18a8], [18aa, 18aa],
    ...
    [10f34, 10f44], [10f51, 10f53], [1e900, 1e943]**/
    ...
    {Mixed, 2}, {Empty, 15}, {Mixed, 2}, {Empty, 1741}, {Full, 2},
    {Mixed, 1}, {Empty, 30901}};
    ...
    0x002ffd3e, 0x0000013d, 0x3dd983ff, 0x00000080, 0x01ffffff, 0xffffff80,
    0x000005ff, 0x0003ffff, 0xdf78001f, 0x00007801, 0x00012dc5, 0x00006000,
    0xfffffffe, 0x0000000b, 0xfff70000, 0x000e001f, 0x0000000f};
    }

    const static UnicodeSet d_Set{const_cast<UnicodeSet::run_t *>(__d_Set_runs), 29, 0, const_cast<UnicodeSet::bitquad_t *>(__d_Set_quads), 29, 0};
    ...
    const static UnicodeSet r_Set{const_cast<UnicodeSet::run_t *>(__r_Set_runs), 17, 0, const_cast<UnicodeSet::bitquad_t *>(__r_Set_quads), 20, 0};
    ...
    0x00040000, 0x00802000, 0x00000001};
    }

    const static UnicodeSet l_Set{const_cast<UnicodeSet::run_t *>(__l_Set_runs), 7, 0, const_cast<UnicodeSet::bitquad_t *>(__l_Set_quads), 3, 0};
    ...
    [abed, abed], [fb1e, fb1e], [fe00, fe0f], [fe20, fe2f], [feff, feff],
    ...
    [11727, 1172b], [1182f, 11837], [11839, 1183a], [11a01, 11a0a],
    ...
    [16b30, 16b36], [16f8f, 16f92], [1bc9d, 1bc9e], [1bca0, 1bca3],
    ...
    {Mixed, 2}, {Empty, 7}, {Mixed, 1}, {Empty, 14}, {Mixed, 3}, {Empty, 1},
    {Mixed, 1}, {Empty, 12}, {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 3},
    {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Empty, 10}, {Mixed, 1},
    {Empty, 607}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 34},
    ...
    0x00000844, 0x00000060, 0x00000030, 0x8003ffff, 0x00003fc0, 0x0003ff80,
    ...
    0x007f0000, 0x00078000, 0x60000000, 0x0000000f, 0xfff80380, 0x00000fe7,
    ...
    const static UnicodeSet t_Set{const_cast<UnicodeSet::run_t *>(__t_Set_runs), 192, 0, const_cast<UnicodeSet::bitquad_t *>(__t_Set_quads), 198, 0};
