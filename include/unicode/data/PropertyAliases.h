...
namespace UCD {
    enum property_t : int {
        ...
        nv, cf, cjkCompatibilityVariant, dm, FC_NFKC, lc, NFKC_CF, scf, slc,
        stc, suc, tc, uc, bmg, bpb, cjkIICore, cjkIRG_GSource,
        cjkIRG_HSource, cjkIRG_JSource, cjkIRG_KPSource, cjkIRG_KSource,
        cjkIRG_MSource, cjkIRG_SSource, cjkIRG_TSource, cjkIRG_UKSource,
        cjkIRG_USource, cjkIRG_VSource, cjkRSUnicode, EqUIdeo, isc, JSN, na,
        na1, Name_Alias, scx, age, blk, sc, bc, bpt, ccc, dt, ea, gc, GCB,
        hst, InPC, InSC, jg, jt, lb, NFC_QC, NFD_QC, NFKC_QC, NFKD_QC, nt,
        ...
        Hyphen, IDC, Ideo, IDS, IDSB, IDST, Join_C, LOE, Lower, Math, NChar,
        OAlpha, ODI, OGr_Ext, OIDC, OIDS, OLower, OMath, OUpper, Pat_Syn,
        Pat_WS, PCM, QMark, Radical, RI, SD, STerm, Term, UIdeo, Upper, VS,
        WSpace, XIDC, XIDS, XO_NFC, XO_NFD, XO_NFKC, XO_NFKD, emoji,
