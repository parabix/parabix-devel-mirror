...
void S2P_16LEKernel::generateMultiBlockLogic(BuilderRef kb, Value * const numOfBlocks) {
    ...
    for (unsigned i = 0; i < 8; i++) {
        ...
        //Those low and high Values were again passed through hsimd_packh/hsimd_packl operations to get
        //parallel bit streams of column of text from the input file (Ref notes)
