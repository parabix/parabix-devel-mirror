...
P2S16KernelWithCompressedOutputOld::P2S16KernelWithCompressedOutputOld(BuilderRef b, StreamSet * basisBits, StreamSet * delCounts, StreamSet * byteStream)
: BlockOrientedKernel(b, "p2s_16_compress2017",
              {Binding{"basisBits", basisBits},
