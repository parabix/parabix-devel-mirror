...
namespace UCD {
    const static std::vector<std::string> property_enum_name = {
        ...
        "cjkPrimaryNumeric", "nv", "cf", "cjkCompatibilityVariant", "dm",
        "FC_NFKC", "lc", "NFKC_CF", "scf", "slc", "stc", "suc", "tc", "uc",
        "bmg", "bpb", "cjkIICore", "cjkIRG_GSource", "cjkIRG_HSource",
        "cjkIRG_JSource", "cjkIRG_KPSource", "cjkIRG_KSource",
        "cjkIRG_MSource", "cjkIRG_SSource", "cjkIRG_TSource",
        "cjkIRG_UKSource", "cjkIRG_USource", "cjkIRG_VSource",
        ...
        "CWKCF", "CWL", "CWT", "CWU", "Dash", "Dep", "DI", "Dia", "EBase",
        "EComp", "EMod", "Emoji", "EPres", "Ext", "ExtPict", "Gr_Base",
        ...
        "Pat_WS", "PCM", "QMark", "Radical", "RI", "SD", "STerm", "Term",
        "UIdeo", "Upper", "VS", "WSpace", "XIDC", "XIDS", "XO_NFC",
    ...
    const static std::vector<std::string> property_full_name = {
        ...
        "kPrimaryNumeric", "Numeric_Value", "Case_Folding",
        "kCompatibilityVariant", "Decomposition_Mapping", "FC_NFKC_Closure",
        "Lowercase_Mapping", "NFKC_Casefold", "Simple_Case_Folding",
        "Simple_Lowercase_Mapping", "Simple_Titlecase_Mapping",
        "Simple_Uppercase_Mapping", "Titlecase_Mapping",
        "Uppercase_Mapping", "Bidi_Mirroring_Glyph", "Bidi_Paired_Bracket",
        ...
        "kRSUnicode", "Equivalent_Unified_Ideograph", "ISO_Comment",
        "Jamo_Short_Name", "Name", "Unicode_1_Name", "Name_Alias",
        "Script_Extensions", "Age", "Block", "Script", "Bidi_Class",
        "Bidi_Paired_Bracket_Type", "Canonical_Combining_Class",
    ...
    static std::unordered_map<std::string, int> alias_map {{
        ...
        {"idcontinue", IDC}, {"identity", identity}, {"ideo", Ideo},
        {"ideographic", Ideo}, {"ids", IDS}, {"idsb", IDSB},
