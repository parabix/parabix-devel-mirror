...
class UCset:
    ...
    # printing
    def generate(self, propertyName, indent=4, property_type='single'):
        ...
        # if property is to generate in array form, the following statement
        # will be done separately after the runs and quads defined for the whole array
        if(property_type != 'array' and array_format == True):
            str += (" " * indent) + "}\n\n" + \
                (" " * indent) + \
